...
include { no_background; alternativeAlleles_background; samePromoter_background; otherRegions_background; region_metadata} from './../backgroundModels'
include { transform_to_vcflike; wilcoxon_compare; prediction_post_process_borzoi; prediction_post_process_sure; add_trinucleotide; region_subselection; mutation_subselection; agreggate_analysis_files } from './processes.nf'
...
include { SimpleBackground as SimpleBackground_otherRegions } from './common.nf'
...
workflow Analyses_predict {
   ...
   otherRegions_analysis_files = Channel.empty()
   if ("$params.analyses" =~ /otherRegions/){
       otherRegions_background(mutation_files)
       otherRegions_analysis_files = SimpleBackground_otherRegions(otherRegions_background.out.background,
                                                      otherRegions_background.out.donorMapping,
                                                           'otherRegions',
                                                           realMutation_predictions,
                                                           region_selection
                                                           )
   ...
   analysis_files = alternativeAlleles_analysis_files
      ...
      .mix(otherRegions_analysis_files)
    ...
    wilcoxon_compare(all_analysis_files)
