...
current_feature = strsplit("${prediction_file.baseName}", "_processed")[[1]][1] #baseName

write_feather(post_process_prediction("$prediction_file"), glue("{current_feature}_ism_predictions.feather"))
